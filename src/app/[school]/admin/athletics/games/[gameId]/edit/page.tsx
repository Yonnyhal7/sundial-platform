  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950 dark:bg-black dark:text-white">
      <div className="mx-auto max-w-3xl px-6 py-8">
        ...
        <form action={updateGame} className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
          <div className="space-y-5">
            <div>
              <label className="mb-2 block text-sm font-medium text-slate-300">Team</label>
              <select name="team_id" required defaultValue={game.team_id || ""} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500">
            ...
            <div>
              ...
              <input name="opponent" required defaultValue={game.opponent} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
            </div>

            <div>
              <label className="mb-2 block text-sm font-medium text-slate-300">Game Date and Time</label>
              <input name="game_date" type="datetime-local" defaultValue={toDateTimeLocalValue(game.game_date)} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
            </div>

            <div>
              <label className="mb-2 block text-sm font-medium text-slate-300">Location</label>
              <input name="location" defaultValue={game.location || ""} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
            </div>

            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-slate-300">Home Score</label>
                <input name="home_score" type="number" defaultValue={game.home_score ?? ""} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
              </div>
              <div>
                <label className="mb-2 block text-sm font-medium text-slate-300">Away Score</label>
                <input name="away_score" type="number" defaultValue={game.away_score ?? ""} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
              </div>
            </div>
            ...
            <div>
              ...
              <input name="result" defaultValue={game.result || ""} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
            </div>
            ...
            <div>
              ...
              <textarea name="notes" rows={4} defaultValue={game.notes || ""} className="w-full rounded-lg border border-slate-700 bg-slate-950 px-4 py-3 text-white outline-none focus:border-blue-500" />
            </div>

            <label className="flex items-center gap-3 rounded-lg border border-slate-800 bg-slate-950 px-4 py-3">
              <input name="is_home" type="checkbox" defaultChecked={game.is_home ?? false} className="h-4 w-4 rounded border-slate-600" />
