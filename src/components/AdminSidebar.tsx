  ...
  return (
    ...
    >
      <path
        ...
        d="M10.3 4.2h3.4l.55 2.15a6.4 6.4 0 0 1 1.35.78l2.08-.62 1.7 2.95-1.55 1.53a6.2 6.2 0 0 1 0 1.56l1.55 1.53-1.7 2.95-2.08-.62c-.42.31-.87.57-1.35.78l-.55 2.15h-3.4l-.55-2.15a6.4 6.4 0 0 1-1.35-.78l-2.08.62-1.7-2.95 1.55-1.53a6.2 6.2 0 0 1 0-1.56L4.67 9.46l1.7-2.95 2.08.62c.42-.31.87-.57 1.35-.78L10.3 4.2Z"
      />
...
export default function AdminSidebar({
  ...
  function renderSetupStepItem(step: (typeof SETUP_STEPS)[number], compact = false) {
        ...
        {!compact && (
          <>
            ...
            >
              ...
              <p className="mt-1 text-xl font-bold tracking-tight">School Setup</p>
            </Link>
            <SetupProgress
  ...
  return (
    <>
      ...
      <aside className="admin-sidebar fixed inset-y-0 left-0 z-40 hidden w-[var(--admin-sidebar-width)] flex-col overflow-y-auto bg-zinc-800 px-3 py-5 text-white shadow-2xl shadow-black/20 dark:bg-black min-[1180px]:px-4 min-[1180px]:py-6 lg:flex">
        <Link
          href={isSetupIncomplete ? `${base}/setup` : base}
          className="mb-6 flex flex-col items-center gap-3 px-2 text-center min-[1180px]:mb-8 min-[1180px]:px-3"
        >
          <SchoolLogo
            schoolName={schoolName}
            logoUrl={logoUrl}
            size="xl"
            className="h-16 w-16 min-[1500px]:h-20 min-[1500px]:w-20"
          />
          <span className="line-clamp-2 text-xl font-bold leading-tight tracking-tight min-[1180px]:text-2xl">
            {schoolName}
          </span>
        </Link>
